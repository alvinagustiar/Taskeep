...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, parentId: $parentId, childrenIds: $childrenIds, taskCount: $taskCount, color: $color)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, parentId,
      const DeepCollectionEquality().hash(_childrenIds), taskCount, color);
